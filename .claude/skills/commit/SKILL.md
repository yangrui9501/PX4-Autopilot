...
**The user is the author. Never add `Co-Authored-By` naming an AI. Per the
[AI policy](../../../docs/en/contribute/ai_assistants.md), end the commit body
with the required disclosure trailer: `Assisted-by: Claude:<model-id>`
